...
// ─────────────────────────────────────────────────────────────
// Current/calibrated model Platt scaling.
// Applies per-league sigmoid calibration to raw O2.5 probability.
// Parameters loaded from data/calibration/league-calibration.json.
//
// This file is SEPARATE from context-calibration.js which handles
// the context_raw model's Stage 9 Platt parameters.
// ─────────────────────────────────────────────────────────────
...
function applyCalibration(rawProb, leagueKey) {
  ...
  return sigmoid(cfg.a * logit(rawProb) + cfg.b);
}

module.exports = { applyCalibration };